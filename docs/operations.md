...
3. Beenden: beliebige Textnachricht in Telegram ODER gesprochen
   ...
   **Sicherer als jede Formel: den Bot beim Namen ansprechen** — „**Utopia**,
   Interview beendet" (Birk, 2026-08-30). Das Komma ist egal, die
   Spracherkennung setzt ohnehin selten eins. Hinter einem „Utopia" darf die
   Formel freier sitzen: **zwei** Einschübe („Utopia, das Interview ist jetzt
   damit beendet") und ein kurzer Dank hinterher („Utopia, Interview beendet,
   vielen Dank fürs Zuhören"). Nur zwischen Name und Formel dürfen höchstens
   zwei Wörter stehen — deshalb beendet „Utopia, kannst du das Interview gleich
